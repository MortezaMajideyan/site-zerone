...
<?php get_template_part('tool/panel-search')?>
    <h2 style="margin: 25px 0;text-align: center;font-family: sas;"> <i style="color: #4cae4c">نظر کاربران زرون</i></h2>
<?php get_template_part('tool/comments')?>
<?php get_template_part('tool/post-title')?>
    <section style="height: auto;background-repeat: no-repeat;margin-top: 50px;padding-top:20px;width: 100%;background-size: 100% 400px;
            background-image: url('<?php echo get_template_directory_uri(). '/images/bg.png' ?>');display: block">
        <h2 style="color: white;text-align: center;font-weight: inherit"><i>مقالات منــتـشــر شده</i></h2>
                            ...
                            <div class="comment" style="height: 363px;padding: 0">
                                <div style="width: 100%;height: 200px">
                                 ...
                                 height: 200px;background-size: 100% 100%;">
                                    ...
                                    <div style="display: none"><i ><?php echo the_excerpt(); ?></i></div>
                                </div>
                                ...
                                <div style="height: 30px;padding-right: 10px;padding-left: 10px ">
                                    <div style="width: 31%;height: auto;text-align: center;float: left">
                                        ...
                                        <?php echo get_post_view($post ->ID)?>
                                    </div>
                                    <div style="width: 31%;height: auto;text-align: center;float: left">
